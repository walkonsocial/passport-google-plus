...
var Context = function(options, authorizationCode, idToken, accessToken) {
  ...
  this.clientId = options.clientId;
    if (!this.clientId && options.hasOwnProperty('clientID')){
        this.clientId = options.clientID;
    }
...
Strategy.prototype.authenticate = function(req, options) {
  ...
  var param = function(name) {
    ...
    if (null !== body[name] && body.hasOwnProperty(name)) return body[name];
    if (null !== query[name] && query.hasOwnProperty(name)) return query[name];
    return undefined;
  };
